...
exports["default"] = exports.fetchBlog = exports.getBlog = void 0;
...
var fetchBlog = (0, _toolkit.createAsyncThunk)('blog/getblog', function _callee(BlogId) {
  var response;
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(_globalAxpi.apiR.get("blog/".concat(BlogId), {
            headers: {
...
var BlogSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {},
  extraReducers: (_extraReducers = {}, _defineProperty(_extraReducers, fetchBlog.pending, function () {// console.log('Pending');
  }), _defineProperty(_extraReducers, fetchBlog.fulfilled, function (state, _ref) {
    var payload = _ref.payload;
    return _objectSpread({}, state, {
      blog: payload
    });
  }), _defineProperty(_extraReducers, fetchBlog.rejected, function () {// console.log('Rejected!');
  }), _extraReducers)
});
