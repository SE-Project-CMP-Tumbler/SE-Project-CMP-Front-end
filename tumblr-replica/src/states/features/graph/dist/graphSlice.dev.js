    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 20:
          ...
          _context.next = 28;
          return regeneratorRuntime.awrap(_globalAxpi.apiR.get("graph/notes/".concat(dispatch.BlogId, "/").concat(dispatch.period, "/").concat(dispatch.rate), {
            headers: {
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 19:
          ...
          AuthStr = "Bearer ".concat(USERTOKEN);
          _context3.next = 27;
          return regeneratorRuntime.awrap(_globalAxpi.apiR.get("graph/total_followers/".concat(dispatch.BlogId, "/").concat(dispatch.period, "/").concat(dispatch.rate), {
            headers: {
              Authorization: AuthStr
            }
          }));
