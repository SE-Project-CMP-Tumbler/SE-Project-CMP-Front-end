...
exports["default"] = exports.UnBlockAsynch = exports.getunBlock = void 0;
...
var UnBlockAsynch = (0, _toolkit.createAsyncThunk)('unblock_blog/:blog_id', function _callee(BlogId, MyBlog) {
  var response;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          console.log(MyBlog);
          _context.next = 3;
          return regeneratorRuntime.awrap(_globalAxpi.apiR["delete"]("block/4/".concat(BlogId), {
            headers: {
...
exports.UnBlockAsynch = UnBlockAsynch;
var initialState = {
  unblock: {
    meta: {
      status: '000',
...
var unBlockSlice = (0, _toolkit.createSlice)({
  name: 'unblock',
  initialState: initialState,
  reducers: {},
  extraReducers: (_extraReducers = {}, _defineProperty(_extraReducers, UnBlockAsynch.pending, function () {}), _defineProperty(_extraReducers, UnBlockAsynch.fulfilled, function (state, _ref) {
    var payload = _ref.payload;
    return _objectSpread({}, state, {
      unblock: payload
    });
  }), _defineProperty(_extraReducers, UnBlockAsynch.rejected, function () {// console.log('Rejected!');
  }), _extraReducers)
});

var getunBlock = function getunBlock(state) {
  return state.unblock.unblock;
};

exports.getunBlock = getunBlock;
var unBlockReducer = unBlockSlice.reducer;
var _default = unBlockReducer;
