...
import './css/CreatePostComp.css';
import Grid from '@mui/material/Grid';
import Modal from '@mui/material/Modal';
import Stack from '@mui/material/Stack';
import ReactEditor from '../CreatPost/ReactEditor';

const CreatePostComp = function Create() {
  ...
  return (
    <>
      <Grid item>
        <div classsName="wttfd">
          <div style={{ backgroundColor: 'white' }}>
            <Stack direction="row">
              <button type="button" className="FOqaP" aria-label="Text" onClick={() => handleOpen()}>
              ...
              <button type="button" className="FOqaP" aria-label="Photo" onClick={() => handleOpen()}>
              ...
              <button type="button" className="FOqaP" aria-label="Quote" onClick={() => handleOpen()}>
              ...
              <button type="button" className="FOqaP" aria-label="Link">
              ...
              <button type="button" className="FOqaP" aria-label="Chat" onClick={() => handleOpen()}>
              ...
              <button type="button" className="FOqaP" aria-label="Audio" onClick={() => handleOpen()}>
              ...
              <button type="button" className="FOqaP" aria-label="Video" onClick={() => handleOpen()}>
