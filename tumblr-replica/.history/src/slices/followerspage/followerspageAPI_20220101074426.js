 ...
 * @returns {object} all followers of this user
 */
 ...
 * @name
 * followedBy
 * @param {object} blogID  The id of the blog to check if he/she is following the current blog
 * @returns {object} true if the blog is following the User else return false
 */
 ...
 * @name
 * searchFollowblog
 * @param {string} userName  the name of the blog you search for
 * @param {object} User  the loged in user
 * @returns {object} searched blog information
 */
...
/**
 * this function is used to follow spacific blog
 * @method
 * @name
 * follow
 * @param {string} blogId  the id of the blog you want to follow
 * @param {object} User  the loged in user
 * @returns {object} return teh response (succeeded or fail)
 */
...
/**
 * this function is used to block spacific blog
 * @method
 * @name
 * block
 * @param {string} blogId  the id of the blog you want to follow
