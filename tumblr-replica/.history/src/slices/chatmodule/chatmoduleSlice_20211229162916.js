...
const chatReducer = createSlice({
  ...
  reducers: {
    ...
    chatUpdate: (state, { payload }) => {
      const newstate = state;
      const pay = {
        text: payload.text, photo: payload.photo, gif: payload.gif, read: payload.read, blog_username: payload.from_blog_username, from_blog_id: payload.from_blog_id, blog_avatar: payload.from_blog_avatar, blog_avatar_shape: payload.from_blog_avatar_shape, blog_title: payload.from_blog_avatar_shapefrom_blog_avatar_shape,
      };
