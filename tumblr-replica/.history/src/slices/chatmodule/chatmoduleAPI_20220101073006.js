 ...
 * @returns {object} response contain  that if the request succeeded or fail
 */
 ...
 * @method
 * @param  {object} blogsID the ids of the two blogs the have this chatt room id
 * @param  {object} elem chat participant information
 * @param {object} User  the loged in user
 * @returns {object} response of the post request contain the chat room id and the user information
 */
...
/**
 * this function is used to delete converstaion
 * @method
 * @param {intger} chatRoomId  the chat room id between two friends
 * @param {object} User  the loged in user
 * @returns {object}  response of the post request (success or fail)
 */
...
/**
 * this function is used to search for someone to chat with
 * @method
 * @param {string} searchWord  the username of the friend that the user searches for
 * @param {object} User  the loged in user
 * @returns {object} the response of the post request contains the blogs that cantain
 * searchWord in there blog names
 */
...
/**
 * this function is used to get the room id of the chat between the
 * two participant in the responsive part
 * @method
 * @param  {object} blogsID the ids of the two blogs the have this chatt room id
 * @param {object} User  the loged in user
 * @returns {object} contain the response of the post request that contain the chat room id and the user information
 */
 ...
 * @method
 * @param {string} searchWord  the username of the friend that the user searches for
 * @param {string} blogUserName the user name of the blog
 * @param {object} User  the loged in user
 * @returns {number} id the id of the blog
 */
...
/**
 * this function is used to set the blog friend name
 * @method
 * @param {string} blogUserName the user name of the blog
 * @param {object} User  the loged in user
 * @returns {object} the friend info
 */
