...
const chatReducer = createSlice({
  ...
  reducers: {
    ...
    chatUpdate: (state, { payload }) => {
      const newstate = state;
      const pay = {
        text: payload.text, photo: null, gif: null, read: false, from_blog_username: 'nadeen', from_blog_id: 148, from_blog_avatar: 'https://cdnb.artstation.com/p/assets/images/images/033/268/113/large/edmerc-d-mercadal-eren-v5.jpg?1609001111', from_blog_avatar_shape: 'circle', from_blog_title: 'nadeen',
      };
