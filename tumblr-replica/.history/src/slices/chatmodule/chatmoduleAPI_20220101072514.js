 ...
 * @returns {object} the response of the post request and the
 * new message
 */
 ...
 * @param {object} User  the loged in user
 * @returns {object} the response of the post request and the user information
 */
 ...
 * @param {object} User  the loged in user
 * @returns {object} contain the response of the post request (success or fail)
 */
