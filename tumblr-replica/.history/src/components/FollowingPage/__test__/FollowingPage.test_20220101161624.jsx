...
describe('FollowingBlog', () => {
  ...
  it('test that the img is visible ', async () => {
    render(<FollowingBlog id={5}
      ...
      expect(followingimg).toHaveAttribute('src', 'https://www.ukrgate.com/eng/wp-content/uploads/2021/02/The-Ukrainian-Book-Institute-Purchases-380.9-Thousand-Books-for-Public-Libraries1.jpeg');
      expect(await screen.findByText(/nadeen/i)).toBeInTheDocument();
  });
});
