...
function Header() {
  ...
  return (
    <Paper style={{ width: '600px', maxWidth: '600px', padding: '20px' }}>
      <Box style={{ display: 'flex' }}>
        ...
        <Box style={{ display: 'flex', width: '20%' }}>
          ...
          <img style={{ width: '30px', height: '30px', borderRadius: '50%', margin: '10px' }} src="https://images.unsplash.com/photo-1518756131217-31eb79b20e8f" alt="" />
        </Box>
      </Box>
      <Box>
        {/* {
