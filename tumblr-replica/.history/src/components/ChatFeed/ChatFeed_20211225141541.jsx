 ...
 * @method
 * @param {string} id id is a prop for this component to know witch chat box will be displayed
 * @param {string} messages messeges is a prop for this component to know
  ...
  return (
    ...
    >
      ...
      <Box style={{ padding: '10px 5px 0 10px' }}>
        {chatFeed.map((value) => (value?.blog_id === User.id
          ? (
            <MyChatFeed
              photo={value?.photo}
              text={value?.text}
