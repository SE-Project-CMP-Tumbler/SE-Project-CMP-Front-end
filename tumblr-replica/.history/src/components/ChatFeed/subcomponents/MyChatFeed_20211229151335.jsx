...
function MyChatFeed({
  ...
  return (
    <Box style={{ display: 'flex', margin: '5px 0px' }}>
      ...
      />
      <Box className={photo ? 'message-part-p' : 'message-part-notp' }style={{
        width: 'fitContent', maxWidth: '150px', padding: '15px', backgroundColor: 'white', borderRadius: '7px', paddingLeft: '5px', margin: '3px 0',
      }}
      >
