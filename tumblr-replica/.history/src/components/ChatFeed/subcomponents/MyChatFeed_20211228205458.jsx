...
function MyChatFeed({
  ...
  return (
    <Box style={{ display: 'flex', margin: '5px 0px' }}>
      <Box style={{
        width: 'fitContent', padding: '15px', backgroundColor: 'white', borderRadius: '7px', paddingLeft: '5px', margin: '3px 0',
      }}
      >
      ...
      <Box style={{
        width: '80%', padding: '10px 0px 0px 0px', backgroundColor: 'white', borderRadius: '7px', paddingLeft: '5px', margin: '5px 0',
      }}
      >
