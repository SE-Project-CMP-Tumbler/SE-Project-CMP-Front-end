...
/**
 * component for  this component is a part from chat to list
 * contain the search bar to sesrch for friend and start chating with this friend
 * @method
 * @returns {*} ChatSearch componenet
 */
function ChatSearch() {
