...
/**
 * Component for render the the top bar of the Chat List in the Responsive view
 * @component
 * @param chats chats is an array the contain information about the chat participants
 * @name
 * ChatListTopBarResp
 * @example
 * return (
...
function ChatListTopBarResp() {
  ...
  return (
    <Box className="top-bar">
      ...
      <Box>
        <Button onClick={() => { dispatch(newMessagePressRes()); }}>
