...
function ChatTopBar({
  ...
  const DeleteConversation = () => {
    dispatch(deleteMessages({chatRoomId, User, is));
  };
  useEffect(() => {
  }, []);
  return (
    <div className="top-bar">
      ...
      <Box className="chat-buttons">
        ...
        <button className="top-bar-icons" type="button" onClick={() => dispatch(removeChatBoxID({ id, img, friendName }))}>
