...
function ChatInput({ chatRoomId, setShowImg }) {
  ...
  */
  ...
  return (
    <Box>
      { showImg
    && (
    <div style={{ width: '275px', height: '180px' }}>
      <button type="button" onClick={() => setShowImg(false)}> X </button>
      <img src={img} style={{ width: '80%', height: '80%' }} alt="" />
    </div>
    )}
      <div>
        <textarea
