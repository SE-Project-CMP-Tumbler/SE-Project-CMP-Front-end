...
/**
 * Component for render the input part of in the chat component
 *
 * @component
 * @name
 * ChatInput
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button type="submit" className="send-button" onClick={handleClick} data-testid='send-button'>
          <svg
            role="img"
            viewBox="0 0 17 17"
            width="17"
