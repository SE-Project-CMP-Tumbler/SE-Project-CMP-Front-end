...
/**
 * Component for render the the top bar in the chat component
 *
 * @component
 * @name
 * ChatTopBar
 * @param {string} friendName  name of chat participant
 * @param {string} img  img of the  chat participant
 * * @param {number} chatRoomId  chatRoomId of the  chat participant
 * @example
 * return (
 *   <ChatTopBar />
 * )
...
function ChatTopBar({
  ...
  return (
    <div className="top-bar1">
      <div style={{
        display: 'flex', width: '100%', height: '100%', backgroundColor: 'rgba(255, 255, 255, 0.3)', backdropFilter: 'blur(10px)',
      }}
      >
