...
function ChatInput({ chatRoomId, setShowImg, showImg }) {
  ...
  */
  ...
  return (
    ...
    >
      <button type="button" style={{ color: 'white',margin: 15px;
    padding: 5px;
    position: absolute;
    right: 0;
    top: 0; }} onClick={() => setShowImg(false)}> X </button>
      <img src={img} style={{ width: '150px', height: '80px', borderRadius: '10px' }} alt="" />
    </div>
    )}
      <div>
        <textarea
