...
import ChatInput from '../subcomponents/MyChatFeed';
...
describe('MyChatFeed', () => {
  ...
  it('test that the img is visible ', async () => {
    render(<MyChatFeed
      ...
      const img = screen.getByTestId('img-id');
      expect(img).toHaveAttribute('src', "https://images.unsplash.com/photo-1551963831-b3b1ca40c98e");
  });
});