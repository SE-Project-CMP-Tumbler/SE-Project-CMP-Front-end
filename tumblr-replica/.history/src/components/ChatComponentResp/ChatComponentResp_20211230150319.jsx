...
import { getChatRoomIdRes, getBlogIdFromBlogUN, getChatFeed, setBlogFriendName } from '../../slices/chatmodule/chatmoduleAPI';
    ...
    dispatch(getBlogIdFromBlogUN({ blogUserName: params.username, User, isUser: true }))
      .then((id1) => {
        dispatch(getBlogIdFromBlogUN({ blogUserName: params.friendname, User, isUser: false }))
          .then((id2) => {
            dispatch(setBlogFriendName(params.friendname));
