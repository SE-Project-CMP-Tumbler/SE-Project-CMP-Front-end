...
function ChatComponentResp({ friendName, id, img }) {
  ...
  const friendbloginfo= useSelector((state) => state.Chat.friendbloginfo);
  ...
  return (
    ...
    >
      <ChatTopBarResp friendName={params.friendname} id={userbloginfo.id} img={userbloginfo.avatar} />
